...
describe("Search & Discovery Engine Integration Tests", () => {
    ...
    beforeAll(async () => {
        ...
        const pSony = await ProductModel.create({
            ...
            baseCurrency: "USD",
            status: "PUBLISHED",
            thumbnail: "https://images.ecommers.test/sony-xm5.png",
            averageRating: 4.8,
            reviewCount: 25,
        ...
        const pAirPods = await ProductModel.create({
            ...
            baseCurrency: "USD",
            status: "PUBLISHED",
            thumbnail: "https://images.ecommers.test/airpods-max.png",
            averageRating: 4.5,
            reviewCount: 40,
        ...
        const pWatch = await ProductModel.create({
            ...
            baseCurrency: "USD",
            status: "PUBLISHED",
            thumbnail: "https://images.ecommers.test/apple-watch.png",
            averageRating: 4.9,
            reviewCount: 12,
        ...
        const pBudget = await ProductModel.create({
            ...
            baseCurrency: "USD",
            status: "PUBLISHED",
            thumbnail: "https://images.ecommers.test/basic-earbuds.png",
            averageRating: 3.2,
            reviewCount: 8,
