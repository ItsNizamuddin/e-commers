...
export class LocationService {
    ...
    async seedDefaultLocations(): Promise<void> {
        ...
        logger.info("Seeding default platform serviceable locations...");

        const defaultLocations: CreateLocationInput[] = [
            {
                code: "bangalore",
                name: "Bangalore",
                type: "CITY",
                ...
                currency: "INR",
                isActive: true,
                deliveryEstimate: "Same-Day / Within 24 Hours",
                deliveryHighlight: "Dispatched fresh daily from Bangalore central kitchen",
                defaultSeoTitleTemplate: "Buy {title} in Bangalore | Fresh Sweets Delivery",
                defaultSeoDescriptionTemplate: "Order authentic {title} delivered across Bangalore within 24h. 100% pure desi ghee.",
                postalCodes: [
                    "560001", "560002", "560003", "560004", "560008", "560011",
                    "560025", "560034", "560038", "560047", "560068", "560076",
            ...
            },
            {
                ...
                deliveryHighlight: "Fresh dispatch from Hyderabad culinary center",
                defaultSeoTitleTemplate: "Buy {title} in Hyderabad | Authentic Delicacies",
                defaultSeoDescriptionTemplate: "Order fresh {title} delivered across Hyderabad. Traditional recipe.",
                postalCodes: [
                    "500001", "500002", "500003", "500004", "500034", "500081",
                    "500082", "500084", "500090"
                ],
            ...
            },
            {
                ...
                deliveryHighlight: "Next-day express delivery across Mumbai MMR",
                defaultSeoTitleTemplate: "Buy {title} in Mumbai | Fresh Delivery",
                postalCodes: ["400001", "400050", "400051", "400099"],
            ...
            },
            {
                ...
                currency: "USD",
                isActive: true,
                deliveryEstimate: "3-5 Business Days (Air Express)",
                deliveryHighlight: "Express international shipping across USA (Customs cleared)",
                defaultSeoTitleTemplate: "Buy {title} Online in USA | Indian Sweets Delivery",
                defaultSeoDescriptionTemplate: "Authentic {title} delivered across the United States. Fast air courier dispatch.",
                postalCodes: ["NATIONWIDE"],
                postalCodePrefixes: [],
                sortOrder: 4,
            },
            {
                ...
                deliveryHighlight: "Fast Gulf air courier delivery across UAE",
                defaultSeoTitleTemplate: "Buy {title} in UAE Dubai | Authentic Traditional Sweets",
                defaultSeoDescriptionTemplate: "Order {title} delivered to Dubai, Abu Dhabi, and Sharjah within 2-3 days.",
                postalCodes: ["NATIONWIDE"],
                postalCodePrefixes: [],
                sortOrder: 5,
            },
        ...
        logger.info(`Seeded ${defaultLocations.length} default locations successfully.`);
    }
}
