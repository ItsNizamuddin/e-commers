...
export interface CategorySocialCardProps {
    name: string;
    description: string;
    image: string;
    metaTitle: string;
...
export function CategorySocialCard({
    name,
    description,
    image,
    metaTitle,
    ...
    setOgImage,
    disabled = false,
}: CategorySocialCardProps) {
    const [copied, setCopied] = useState(false);

    const handleSync = () => {
        setOgTitle(metaTitle || name);
        setOgDescription(metaDescription || description);
        setOgImage(image);
        setCopied(true);
            ...
            <div className="mb-4 rounded-lg overflow-hidden border border-slate-200 dark:border-neutral-800 bg-slate-50 dark:bg-[#0A0A0A] max-w-sm">
                ...
                <div className="p-2.5">
                    ...
                    <div className="text-xs font-semibold text-slate-900 dark:text-white truncate mt-0.5">
                        {ogTitle || metaTitle || name || "Social Card Title"}
                    </div>
                    <p className="text-[11px] text-slate-500 dark:text-neutral-400 line-clamp-2 mt-0.5 leading-snug">
                        {ogDescription || metaDescription || description || "Preview description for shared links across social messaging platforms."}
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-3">
                <div>
                    ...
                    <Input
                        ...
                        placeholder={metaTitle || name || "Social title"}
                        disabled={disabled}
                    />
                </div>
                ...
                <div>
                    ...
                    <Textarea
                        ...
                        placeholder={metaDescription || description || "Brief description for social media feeds"}
                        disabled={disabled}
                    />
                </div>
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="https://images.unsplash.com/... or category banner URL"
                        disabled={disabled}
                    />
                </div>
            </div>
